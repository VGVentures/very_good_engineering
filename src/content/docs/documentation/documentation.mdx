...
If your project depends on tools like build_runner, custom_lint, or flutter gen-l10n, document their purpose and usage directly in the README or linked documentation. (cite or link example like io Project)
...
Include context on why the tool is present and when it should or shouldn’t be used:
    - Where the config lives (e.g., l10n.yaml, .dart_tool/, pubspec.yaml)
...
Use the public_member_api_docs rule to enforce this automatically. If it’s public, it should be documented.
