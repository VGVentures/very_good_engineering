...
<Diagram light={glossaryAppBar} dark={glossaryAppBar} alt="tktktk" />
...
<Diagram light={glossaryColumn} dark={glossaryColumn} alt="tktktk" />
...
<Diagram light={glossaryDrawer} dark={glossaryDrawer} alt="tktktk" />
...
<Diagram light={glossaryGridView} dark={glossaryGridView} alt="tktktk" />
...
<Diagram light={glossaryListView} dark={glossaryListView} alt="tktktk" />
...
<Diagram light={glossaryRow} dark={glossaryRow} alt="tktktk" />
